...
<body>
    ...
    <div class="extensoes">
        ...
        <ul>
            <li>
                <p class="letrag">Site Educação Física <a href="./resp_pag2.html"><button type="button">Acessar</button></a> </p>
    ...
    <div class="botoes">
        <a href="./resp_pag3.html"><button class="submit" type="button">Incluir projeto</button></a>
    </div>
    <footer>
        <div class="rodape">
